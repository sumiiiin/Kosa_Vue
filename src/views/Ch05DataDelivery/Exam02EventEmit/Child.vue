<template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mt-3">
                <h6>[자식 -> 부모 -> 자식]</h6>
                <button class="btn btn-danger btn-sm me-2" @click="handleIncrementEvent">증가(increment-event 이벤트 발생)</button>
...
const emit = defineEmits(["child-event-1","child-event-2", "increment-event", "decrement-event"]);// 이벤트는 emit에 등록해야 한다.
